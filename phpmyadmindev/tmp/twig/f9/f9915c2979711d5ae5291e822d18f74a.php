...
";
    ...
    {
        return new Source("", "recent_favorite_table_no_tables.twig", "/Applications/XAMPP/xamppfiles/htdocs/local.web/phpmyadmindev/templates/recent_favorite_table_no_tables.twig");
    }
}
