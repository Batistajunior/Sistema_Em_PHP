...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/Applications/XAMPP/xamppfiles/htdocs/local.web/phpmyadmindev/templates/database/structure/bulk_action_modal.twig");
    }
}
